...
// use App\Http\Requests\controller_nameIndexRequest;
// use App\Http\Requests\controller_nameStoreRequest;
// use App\Http\Requests\controller_nameShowRequest;
// use App\Http\Requests\controller_nameUpdateRequest;
// use App\Http\Requests\controller_nameDeleteRequest;
/**
 * Class controller_name.
 */
class controller_nameController extends BaseController
{
    /*
     ...
     * @var string
     */
    // protected $model = controller_name::class;
     ...
     * @var string
     */
    // protected $indexRequest = controller_nameIndexRequest::class;
     ...
     * @var string
     */
    // protected $storeRequest = controller_nameStoreRequest::class;
     ...
     * @var string
     */
    // protected $showRequest = controller_nameShowRequest::class;
     ...
     * @var string
     */
    // protected $updateRequest = controller_nameUpdateRequest::class;
     ...
     * @var string
     */
    // protected $deleteRequest = controller_nameDeleteRequest::class;
